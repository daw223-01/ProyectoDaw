                    ...
                    <footer class="bg-dark text-center text-white">
                        <div class="container p-4 pb-0">
                            <section class="mb-4">
                                ...
                                {/* <!-- Twitter --> */}
                                <a class="btn btn-outline-light btn-floating rounded-circle border border-4" href="https://twitter.com/Raulbs1099" role="button">
                                ...
                                {/* <!-- Instagram --> */}
                                <a class="btn btn-outline-light btn-floating rounded-circle border border-4" href="https://www.instagram.com/raulbs10/?hl=es" role="button">
                                ...
                                {/* <!-- Linkedin --> */}
                                <a class="btn btn-outline-light btn-floating rounded-circle border border-4" href="https://www.linkedin.com/in/raulbragadosanz/" role="button">
                                ...
                                {/* <!-- Github --> */}
                                <a class="btn btn-outline-light btn-floating rounded-circle border border-4" href="https://github.com/daw223-01" role="button">
                                ...
                                {/* <!-- Tiktok --> */}
                                <a class="btn btn-outline-light btn-floating rounded-circle border border-4" href="https://www.tiktok.com/@raulbs10" role="button">
                                ...
                                {/* <!-- Twitch --> */}
                                <a class="btn btn-outline-light btn-floating rounded-circle border border-4" href="https://www.twitch.tv/raulbs10?lang=es" role="button">
