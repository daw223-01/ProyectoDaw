        ...
        return (
            <div className="container-fluid pt-5">
                ...
                <div id="canales" className="row">
                    ...
                    <div className="card shadow bg-transparent col-md-3 col-7 border border-2 border-light me-5">
                        <a href="https://www.youtube.com/@EntrenaSergioPeinado" target="_blank">
                    ...
                    <div className="card shadow bg-transparent col-md-3 col-7 border border-2 border-light me-5">
                        <a href="https://www.youtube.com/GymVirtual" target="_blank">
                            <div className="card-body">
                    ...
                    <div className="card shadow bg-transparent col-md-3 col-7 border border-2 border-light">
                        <a href="https://www.youtube.com/@buff-academy" target="_blank">
                            <div className="card-body">
